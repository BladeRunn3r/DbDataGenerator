...
CREATE TABLE car_features (
    ...
    CONSTRAINT car_features_pk PRIMARY KEY (car_id)
) ;
...
CREATE TABLE seller (
    ...
    full_name varchar2(100)  NOT NULL,
    seller_type varchar2(20)  NOT NULL,
    company_name varchar2(80)  NULL,
...
CREATE TABLE new_car (
    ...
    mileage number(6)  NOT NULL,
    price number(6)  NOT NULL,
    CONSTRAINT new_car_pk PRIMARY KEY (car_id)
) ;

-- foreign keys
-- Reference: car_features_car (table: car_features)
ALTER TABLE car_features ADD CONSTRAINT car_features_car
    FOREIGN KEY (car_id)
